...
#' @param shape; string; argument passed to aes in geom_point(). Has to be an exact match
...
# logFC=1
  ...
  vac63_diffcyt_boxplot <- function(diffcyt_result, sce, counts=NULL, FDR, logFC=NULL, shape=NULL){
  ...
  long_sig_results$timepoint <- gsub("_", "", long_sig_results$timepoint)
