...
#'
#' This function makes pretty UMAP plots. It takes a dataframe as input and uses the UMAP1 and UMAP2 columns as X and Y coordinates and any
...
flo_umap <- function (df, color_by, facet_by = NULL, only_show = NULL){
  ...
  plt <- ggplot2::ggplot(data, ggplot2::aes(x = UMAP1, y = UMAP2, color = marker))+
    ...
    ggplot2::coord_cartesian(xlim=c(-13.5, 10), ylim=c(-11.2, 11.3))
}
