...
data2 <- read.csv("/Users/s1249052/PhD/cytof/better_gating/big_flowsoms/FlowSOM_all_cd4s_baseline_dod_t6_(copy)_(copy)_results/results/cluster_abundances.csv")
...
setwd("/Users/s1249052/PhD/cytof/better_gating/big_flowsoms/FlowSOM_all_cd4s_baseline_dod_t6_(copy)_(copy)_results/results/cluster_medians")
...
data_medians_all <- dplyr::select(data_medians_all, -CD45, -CD8, -CD4, -Va7.2, -Vd2, -CD3, -CD20, -TIM.3, -CXCR5, -CX3CR1, -CD103,  -IntegrinB7, -TCRgd)
...
mat2 <- dplyr::select(mat, -CD45, -CD8, -CD4, -Va7.2, -Vd2, -CD3, -CD20, -TIM.3, -CXCR5, -CX3CR1, -CD103,  -IntegrinB7, -TCRgd)
