...
ggplot2::ggsave("~/postdoc/scRNAseq/figures_for_Ange/oligo_tsne.png", oligo_tsne, height = 7, width = 14, bg="white")
...
ggplot2::ggsave("~/postdoc/scRNAseq/figures_for_Ange/oligo_clusters.png", oligo_clusters, height = 4, width = 6, bg="white")
...
ggplot2::ggsave("~/postdoc/scRNAseq/figures_for_Ange/clean_oligo_clusters.png", clean_oligo_clusters, height = 4, width = 6, bg="white")
...
SeuratDisk::SaveH5Seurat(pbmc, filename = "~/postdoc/scRNAseq/Seurat_Objects/demultiplexed_primary.h5Seurat", overwrite = TRUE)
...
SeuratDisk::SaveH5Seurat(pbmc, filename = "~/postdoc/scRNAseq/Seurat_Objects/processed_demultiplexed_primary.h5Seurat", overwrite = TRUE)
SeuratDisk::SaveH5Seurat(pbmc, filename = "~/postdoc/scRNAseq/Seurat_Objects/dimred_processed_demultiplexed_primary.h5Seurat", overwrite = TRUE)
...
DimPlot(pbmc, reduction = "umap", group.by = "sample_ID")


pbmc@meta.data$sample_ID <- factor(pbmc@meta.data$sample_ID, levels = c("v313_Baseline", "v315_Baseline", "v320_Baseline", "v313_T6", "v315_T6", "v320_T6"))
...
cluster5.markers <- FindMarkers(pbmc, ident.1 = 12, min.pct = 0.25)
...
cluster_umpa <- DimPlot(pbmc, label=TRUE)
ccl5_umap <- FeaturePlot(pbmc, "CCL5")
cd38_umap <- FeaturePlot(pbmc, "CD38")

cowplot::plot_grid(cluster_umpa, ccl5_umap, cd38_umap)
...
monocle3::plot_cells(cell_size = 2,
  cds = pbmc.cds,
...
SeuratDisk::SaveH5Seurat(pbmc, filename = "~/postdoc/scRNAseq/Seurat_Objects/pseudotime_primary.h5Seurat", overwrite = TRUE)
