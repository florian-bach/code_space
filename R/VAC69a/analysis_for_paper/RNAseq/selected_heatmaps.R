...
inflammatory_list <- c("IL1RN","IL1B",  "TNF", "IL15", "IL27", "STAT1", "STAT2", "GBP1", "GBP2", "OASL", "MX1", "MX2",
                      ...
                      "CSF1", "CXCL10", "IDO1", "TNFa", "TLR", "NLRP", "MDA5", "MAVS")
...
t#p_keep <- "DoD_Baseline";chosen_list <- inflammatory_list
...
pdf("/home/flobuntu/PhD/figures_for_thesis/chapter_1/vivax_rna_t6_heat.pdf", height = 1.1, width=8)
