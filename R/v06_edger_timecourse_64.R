...
# read in data 
data <- read.csv("/Users/s1249052/PhD/flow_data/vac69a/t_cells_only/better_gating/double_flowsoms/FlowSOM_big_timecourse_06a_results/results/cluster_abundances.csv")
data2 <- read.csv("/Users/s1249052/PhD/flow_data/vac69a/t_cells_only/better_gating/double_flowsoms/FlowSOM_big_timecourse_06b_results/results/cluster_abundances.csv")
