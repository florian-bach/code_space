...
As a reminder, on the left are the fractions we're modelling. To deal with missing data at infections 12 & 13 I used weighted linear regression of non-`NA`, log-transformed case counts to model the number of cases at each infection (dashed line) and imputed the rounded values at 12 & 13. 
