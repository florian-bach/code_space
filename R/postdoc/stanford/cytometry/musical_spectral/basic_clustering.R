...
(unclean_heatmap <- plotExprHeatmap(sce,
                                    ...
                                    scale = "first",
                                    q=0.05,
                                    features=plotting_markers,
                                    # musical_panel$Marker,
                                    row_clust = TRUE,
                                    hm_pal = viridis::inferno(n=5),
                                    col_clust = FALSE))

png("~/postdoc/stanford/cytometry/spectral/MUSICAL/all_lrs.png", width=12, height=8, units="in", res=444)
draw(unclean_heatmap)
dev.off()
