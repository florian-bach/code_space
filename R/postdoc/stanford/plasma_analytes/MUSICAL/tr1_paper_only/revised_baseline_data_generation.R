...
unclean_data <- combo_with_meta %>%
  ...
  mutate(id_cat=paste(plate_number, id, sep="_"),
         ...
         qpcr=as.numeric(new_qpcr),
         log_qpcr = log10(new_qpcr+0.01),
         qpcr_cat=case_when(new_qpcr==0~"0", 
                            new_qpcr>0 & new_qpcr<10~ ">1",
                            new_qpcr>10 & new_qpcr<100~ ">10",
                            new_qpcr>100 & new_qpcr<1000~ ">10e2",
                            new_qpcr>1000 & new_qpcr<10000~ ">10e3",
                            new_qpcr>10000 & new_qpcr<100000~ ">10e4",
                            new_qpcr>100000 & new_qpcr<1000000~ ">10e5",
                            new_qpcr>1000000 & new_qpcr<10000000~ ">10e6",
                            new_qpcr>10000000 ~ ">10e7"),
