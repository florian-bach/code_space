...
combo_as_results <- read.csv("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/combo_as_results_with_fc.csv", check.names = FALSE)
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/big_indie_sig_only_pca.png", big_indie_pca, width = 10, height = 10, dpi=444, bg="white")
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/big_indie_asymp_pca.png", big_indie_pca2, width = 10, height = 10, dpi=444, bg="white")
...
#         axis.text = element_blank())
# 
# ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/big_indie_symp_pca.png", big_indie_pca3, width = 10, height = 10, dpi=444, bg="white")
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/big_pca.png", big_pca_plot, width = 8, height = 5, dpi=444, bg="white")
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/overall_distance_lollipop.png", overall_distance_lollipop, bg="white", height=8, width = 5, dpi=444)
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/overall_distance_dotplot.png", overall_distance_dotplot, bg="white", height=4, width = 4, dpi=444)
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/pc1_distance_lollipop.png", pc1_distance_lollipop, bg="white", height=8, width = 5, dpi=444)
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/pc1_distance_dotplot.png", pc1_dotplot, bg="white", height=4, width = 4, dpi=444)
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/pc2_distance_lollipop.png", pc2_distance_lollipop, bg="white", height=8, width = 5, dpi=444)
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/pc1_distance_dotplot.png", pc2_dotplot, bg="white", height=4, width = 4, dpi=444)
...
ggsave("~/postdoc/stanford/plasma_analytes/MUSICAL/combo/tr1_paper/figures/pc2_day14_distance_lollipop.png", pc2_day14_distance_lollipop, bg="white", height=8, width = 5, dpi=444)
