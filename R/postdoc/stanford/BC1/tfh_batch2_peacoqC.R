...
dir_prepr <- "~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/Preprocessed/"
dir_raw <- "~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/Preprocessed/"
files <- list.files("~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/Preprocessed", pattern="*.fcs", full.names = FALSE, recursive = FALSE)
dir_QC <- "~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/peacoQC"
...
panel <- data.frame("fcs_colname"=rownames(premessa_table[1]),
                    "marker_name"=premessa_table[1]$`T FH PANEL_B1 1001.fcs`,
                    "marker_class"="type")

panel$antigen <- ifelse(panel$marker_name=="", panel$fcs_colname, panel$marker_name)


markers_of_interest <- panel$antigen[c(1:4,8:11)]
channels_of_interest <- panel$fcs_colname[c(1:4,8:11)]
compensation_matrix <- read.csv("~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/comp_matrix.csv", check.names = FALSE, row.names = 1)
...
# how the comp was made ####
# 
# 
# ss_file_paths <- list.files("~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/comp_files/", pattern="*.fcs", full.names = TRUE)
# ss_files <- list.files("~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/comp_files/", pattern="*.fcs", full.names = FALSE)
...
#                   stain_match = "regex")
# 
# write.csv(comp, "~/postdoc/stanford/clinical_data/BC1/tfh_data/raw_tfh_batch2/comp_matrix.csv", quote = FALSE, row.names = TRUE)
