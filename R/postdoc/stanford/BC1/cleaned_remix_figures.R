...
ggsave("/Users/fbach/postdoc/stanford/clinical_data/BC1/remix/figures_for_paper/final_version/all_cord_blood_matmal.png", all_cord_blood_matmal, height=7.5, width=8, bg="white", dpi=444)
