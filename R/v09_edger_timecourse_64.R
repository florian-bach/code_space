...
data <- read.csv("C:/Users/Florian/PhD/cytof/vac69a/double_flowsoms/double_flowsoms/FlowSOM_big_timecourse_09a_results/results/cluster_abundances.csv")
data2 <- read.csv("C:/Users/Florian/PhD/cytof/vac69a/double_flowsoms/double_flowsoms/FlowSOM_big_timecourse_09b_results/results/cluster_abundances.csv")
...
flo_set <- read.flowSet(files_list[11:15], transformation = FALSE, truncate_max_range = FALSE)
...
short[,3] <- data[,3]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short[,4] <- data[,4]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short[,5] <- data[,5]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short[,6] <- data[,6]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short[,7] <- data[,7]*nrow(flo_set@frames[[files_list[14]]]@exprs)
...
short2 <- data2
short2[,3] <- data2[,3]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short2[,4] <- data2[,4]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short2[,5] <- data2[,5]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short2[,6] <- data2[,6]*nrow(flo_set@frames[[files_list[14]]]@exprs)
short2[,7] <- data2[,7]*nrow(flo_set@frames[[files_list[14]]]@exprs)
# combine
...
deg_base_dod6$matters <- ifelse(short[,1] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), ifelse(short[,5] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), "matters_not", "matters"), "matters")
deg_base_dod$matters <- ifelse(short[,1] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), ifelse(short[,4] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), "matters_not", "matters"), "matters")
deg_dod_dod6$matters <- ifelse(short[,4] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), ifelse(short[,5] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), "matters_not", "matters"), "matters")
deg_base_c8$matters <- ifelse(short[,1] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), ifelse(short[,2] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), "matters_not", "matters"), "matters")
deg_base_c10$matters <- ifelse(short[,1] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), ifelse(short[,3] < 0.01*nrow(flo_set@frames[[files_list[14]]]@exprs), "matters_not", "matters"), "matters")

# add volunteer, cluster column & collate deglists 
deg_base_dod6$Volunteer <- "v09"
deg_base_dod$Volunteer <- "v09"
deg_dod_dod6$Volunteer <- "v09"
deg_base_c8$Volunteer <- "v09"
deg_base_c10$Volunteer <- "v09"
...
setwd("C:/Users/Florian/PhD/cytof/vac69a/double_flowsoms/double_flowsoms/FlowSOM_big_timecourse_09a_results/results/cluster_medians/")
...
base_dod_clusters <- short[c(as.numeric(clusters_base_dod$Cluster)),c(4,1)]
...
# ggsave("v09_heatmap_plus_abundance_base_dod6.pdf", grid.arrange(comparison_base_dod6, base_dod6_bar, layout_matrix = rbind(c(1,1,NA),c(1,1,2),c(1,1,NA))), height = 20, width=28)
# ggsave("v09_heatmap_plus_abundance_dod_dod6.pdf", grid.arrange(comparison_dod_dod6, dod_dod6_bar, layout_matrix = rbind(c(1,1,NA),c(1,1,2),c(1,1,NA))), height = 20, width=28)
# ggsave("v09_heatmap_plus_abundance_base_dod.pdf", grid.arrange(comparison_base_dod, base_dod_bar, layout_matrix = rbind(c(1,1,NA),c(1,1,2),c(1,1,NA))), height = 20, width=28)
# 

ggsave("v09_01_heatmap_plus_abundance_base_dod6.pdf", grid.arrange(comparison_base_dod6, base_dod6_bar, layout_matrix = rbind(c(1,1,NA),c(1,1,2),c(1,1,NA))), height = 20, width=28)
ggsave("v09_01_heatmap_plus_abundance_dod_dod6.pdf", grid.arrange(comparison_dod_dod6, dod_dod6_bar, layout_matrix = rbind(c(1,1,NA),c(1,1,2),c(1,1,NA))), height = 20, width=28)
ggsave("v09_01_heatmap_plus_abundance_base_dod.pdf", grid.arrange(comparison_base_dod, base_dod_bar, layout_matrix = rbind(c(1,1,NA),c(1,1,2),c(1,1,NA))), height = 20, width=28)
...
up_dod_dod6$SubSet <- c("CD8", "DN", "CD4", "DN", "Vd2")
...
write.csv(up_dod_dod6, "/Users/s1249052//PhD/cytof/better_gating/double_flowsoms/figures/V09_up_dod_dod6.csv")
